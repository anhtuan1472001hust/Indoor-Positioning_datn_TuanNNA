...
import com.tuanna_datn.wifiindoorpositioning.wifiindoorpositioning.adapter.holder.AccessPointSection;
import com.tuanna_datn.wifiindoorpositioning.wifiindoorpositioning.adapter.holder.ReferencePointSection;
...
public class ProjectDetailActivity extends AppCompatActivity implements View.OnClickListener, RecyclerItemClickListener.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (projectId == null) {
            Toast.makeText(getApplicationContext(), "Không tìm thấy không gian này", Toast.LENGTH_LONG).show();
            this.finish();
        }
...
//        Toast.makeText(this,"onItemClick pos>"+position, Toast.LENGTH_SHORT).show();
    ...
    private void showDeleteDialog(final AccessPoint accessPoint,final ReferencePoint referencePoint) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, android.support.v7.appcompat.R.style.Theme_AppCompat_DayNight_Dialog);
        if (accessPoint != null) {
