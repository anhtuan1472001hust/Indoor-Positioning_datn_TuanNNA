...
import com.tuanna_datn.wifiindoorpositioning.wifiindoorpositioning.adapter.ReferenceReadingsAdapter;
...
public class AddOrEditReferencePointActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (projectId == null) {
            Toast.makeText(this, "Không tìm thấy Reference Point", Toast.LENGTH_LONG).show();
            this.finish();
        }
        ...
        if (isEdit) {
            ...
            Log.e("Bello","aps: " + aps);
            if (aps.isEmpty()) {
                Toast.makeText(this, "Không tìm thấy Access Point nào", Toast.LENGTH_SHORT).show();
            }
    ...
    protected void onResume() {
        if (!isEdit) {
            ...
            Log.e("Bello", "caliberationStarted");
            if (!isCaliberating) {
                isCaliberating = true;
                refresh();
            }
    ...
    private void caliberationCompleted() {
        isCaliberating = false;
        Log.e("Bello", "caliberationCompleted");
        Map<String, List<Integer>> values = readings;
        Log.e("Bello", "readings: " + readings);
...
//            apsWithReading = realm.copyToRealmOrUpdate(apsWithReading);
            ...
            realm.commitTransaction();
            Toast.makeText(this,"Đã cập nhật Reference Point", Toast.LENGTH_SHORT).show();
            this.finish();
        }
    }
    ...
    class AvailableAPsReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.e("Bello","scanResults: " + mainWifi.getScanResults());
            ++readingsCount;
            Log.e("Bello","readingsCount: " + readingsCount);
            ...
            Log.e("Bello", "Count:" + readingsCount+" scanResult:"+ scanResults.toString()+" aps:"+aps.toString());
        }
    }
